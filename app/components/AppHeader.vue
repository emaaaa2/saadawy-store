<template>
  <header class="px-4 py-3 bg-olive relative">
    <div class="flex items-center justify-between gap-4">
      <NuxtLink to="/">
        <img src="/logo.svg" alt="Saadawy Store" class="h-16" />
      </NuxtLink>

      <nav class="hidden md:flex items-center gap-6 text-beige font-medium">
      ...
      <div class="flex items-center gap-4 text-beige">
        <div
          class="hidden lg:flex items-center bg-beige/10 rounded-full px-4 py-2 gap-2"
        >
        ...
        <button
          class="lg:hidden hidden sm:block hover:text-gold transition"
          aria-label="Search"
        >
    ...
    >
      ...
      <div
        class="flex items-center gap-6 pt-4 mt-4 border-t border-beige/20 sm:hidden"
      >
        <button
