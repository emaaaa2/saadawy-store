<template>
  <header class="px-6 py-4 bg-olive relative">
    <div class="flex items-center gap-10">
      ...
      <nav class="hidden md:flex items-center gap-8 text-beige font-medium text-base flex-1">
      ...
      <div class="flex items-center gap-5 text-beige shrink-0">
        <div class="hidden lg:flex items-center bg-beige/10 rounded-full px-4 py-2 gap-2">
        ...
        <button class="lg:hidden hidden sm:block hover:text-gold transition" aria-label="Search">
        ...
        <button class="md:hidden" aria-label="Menu" @click="isMenuOpen = !isMenuOpen">
    ...
    <div
      v-if="isMenuOpen"
      class="md:hidden pt-4 mt-4 border-t border-beige/20 text-beige"
    >
      ...
      <div class="flex items-center gap-6 pt-4 mt-4 border-t border-beige/20 sm:hidden">
        <button class="flex items-center gap-2 hover:text-gold transition" @click="isMenuOpen = false" aria-label="Search">
